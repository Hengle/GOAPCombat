                ...
                if (split.Length > 1)
                {
                    switch (split[1])
                    {
                        ...
                        case nameof(Location):
                            ...
                            break;
                        case nameof(Stamina):
                            var traitStamina = stateData.GetTraitOnObjectAtIndex<AI.Planner.Domains.Stamina>(traitBasedObjectIndex);
                            arguments[i] = split.Length == 3 ? traitStamina.GetField(split[2]) : traitStamina;
                            break;
                        case nameof(Player):
