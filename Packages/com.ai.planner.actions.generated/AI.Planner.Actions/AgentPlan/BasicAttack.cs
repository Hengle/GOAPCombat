...
namespace AI.Planner.Actions.AgentPlan
{
    ...
    struct BasicAttack : IJobParallelForDefer
    {
        ...
        {
            var AgentFilter = new NativeArray<ComponentType>(3, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.Agent>(),[1] = ComponentType.ReadWrite<Unity.AI.Planner.DomainLanguage.TraitBased.Location>(),[2] = ComponentType.ReadWrite<AI.Planner.Domains.Stamina>(),  };
        ...
        StateTransitionInfoPair<StateEntityKey, ActionKey, StateTransitionInfo> ApplyEffects(ActionKey action, StateEntityKey originalStateEntityKey)
        {
            ...
            var newStaminaBuffer = newState.StaminaBuffer;
            {
                    var @Stamina = newStaminaBuffer[originalAgentObject.StaminaIndex];
                    @Stamina.@Amount -= 1;
                    newStaminaBuffer[originalAgentObject.StaminaIndex] = @Stamina;
            }
