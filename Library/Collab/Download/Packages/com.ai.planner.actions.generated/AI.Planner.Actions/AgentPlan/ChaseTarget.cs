...
namespace AI.Planner.Actions.AgentPlan
{
    ...
    struct ChaseTarget : IJobParallelForDefer
    {
        ...
        {
            var AgentFilter = new NativeArray<ComponentType>(3, Allocator.Temp){[0] = ComponentType.ReadWrite<AI.Planner.Domains.Agent>(),[1] = ComponentType.ReadWrite<AI.Planner.Domains.EyeSight>(),[2] = ComponentType.ReadWrite<Unity.AI.Planner.DomainLanguage.TraitBased.Location>(),  };
            ...
            for (int i1 = 0; i1 < TowardsObjectIndices.Length; i1++)
            {
                ...
                var actionKey = new ActionKey(k_MaxArguments) {
                  ...
                  if (!new ChasePrecondition().CheckCustomPrecondition(stateData, actionKey))
                    continue;
